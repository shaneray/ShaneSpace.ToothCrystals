...
namespace ToothCrystal.Areas.Admin.Controllers
{
    public partial class FAQController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FAQController Actions { get { return MVC.Admin.FAQ; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Admin/Views/FAQ/Create.cshtml";
            public readonly string Delete = "~/Areas/Admin/Views/FAQ/Delete.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/FAQ/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/FAQ/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FAQController : ToothCrystal.Areas.Admin.Controllers.FAQController
    {
        ...
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ToothCrystal.Areas.Admin.Models.FAQ.CreateViewModel model);

        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(ToothCrystal.Areas.Admin.Models.FAQ.CreateViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id, ToothCrystal.Areas.Admin.Models.FAQ.CreateViewModel model);

        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(string id, ToothCrystal.Areas.Admin.Models.FAQ.CreateViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id, System.Web.Mvc.FormCollection collection);
